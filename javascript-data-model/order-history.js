var orderHistory = [
  ...
  },
  {
    ...
    productDetails: [
      {
        productCategory: 'gaming',
        itemDescription: 'GameCube Controller - Super Smash Bros. Edition (Nintendo Switch)',
        authorLastName: null,
        authorFirstName: null,
        returnWindowStatus: 'Return window closed on Aug 4, 2020',
        itemCost: '$94.95'
      },
      {
        productCategory: 'textbook',
        itemDescription: 'The Art of Sql',
        authorLastName: 'Faroult',
