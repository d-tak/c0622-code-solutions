var orderHistory = [
  ...
  },
  {
    ...
    dropStatus: null,
    itemDescription: ['GameCube Controller - Super Smash Bros. Edition (Nintendo Switch)', 'The Art of Sql'],
    authorLastName: ['', 'Faroult'],
    authorFirstName: ['', 'Stephanie'],
    returnWindowStatus: ['Return window closed on Aug 4, 2020', 'Return window closed on Aug 4, 2020'],
